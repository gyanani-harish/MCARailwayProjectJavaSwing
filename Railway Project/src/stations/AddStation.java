...
public class AddStation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(j1, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
            ...
            String code=j2.getText();
            String name=j1.getText();
            String q="insert into "+
                    DatabaseConnection.TABLE_STATION_CODE_AND_NAME
                    +" values(upper('"+name+"'),upper('"+code+"'))";
            System.out.println(q);
            
            if(DatabaseConnection.execute(q))
            {
                JOptionPane.showMessageDialog(null," Station not added");
            }
            else
            {
