 ...
 * @author harish
 */
public class DeleteStationByName extends javax.swing.JFrame {

    /**
     * Creates new form DeleteStationByName
     */
    public DeleteStationByName() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            String q = "delete from " + DatabaseConnection.TABLE_STATION_CODE_AND_NAME
    ...
    private void getStationNamesListFromDB() {
        String q1 = "select stationname from " + DatabaseConnection.TABLE_STATION_CODE_AND_NAME
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteStationByName.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteStationByName().setVisible(true);
            }
        });
    }
